...
-- 1. **Write a query to display the team details.
-- Display the records sorted in the order of team name.**
SELECT name FROM team
ORDER BY name ;
-- 2. **Write a query to display the player details whose name starts with a letter `S` and who do not belong to
-- the country 'South Africa'. Display the records sorted in descending order based on player name.**
SELECT name FROM player 
WHERE name LIKE 's%' AND country!='South Africa'
ORDER BY name DESC;
-- 3. **Write a query to display the event number and the seconds taken for each event.
...
-- 4. **Write a query to display the event numbers of those events which has sum of raid points
-- and defending points greater than or equal to 3. Display the records sorted in ascending order based on event_no.**
SELECT event_no FROM event
WHERE raid_points + defending_points >= 3
ORDER BY event_no ; 
-- 5. **Write a query to display the name of all the players who belong to the country India or Iran.
...
ORDER BY name ASC; 
-- 7. **Write a query to display the names of all the skills that start with `Defend`. 
-- Display the records sorted in ascending order based on skill name.**
SELECT name FROM skill
WHERE name LIKE 'Defend%'
ORDER BY name ASC;
-- 8. **Write a query to display all the stadium names that ends with `Complex`. 
...
-- 9. **Write a query to display the winner team ids and the scores of those teams whose scores are less than 35. 
-- Display the records sorted in descending order based on outcome id.**
SELECT id FROM outcome
WHERE score < 35
ORDER BY id DESC;
-- 10. **Write a query to display the game details of those games that were played between January and March of 2020.
...
-- 11. **Write a query to display the names of players who are Raiders.
-- Display the records sorted in ascending order based on player name.**
SELECT name FROM player
WHERE skill_id > 1
ORDER BY name ASC;
-- 12. **Write a query to display the event number, raid points and defence points
-- scored in the first innings of the game that was played on `2020-01-26`.
-- Display the records sorted in ascending order based on event number.**
...
ORDER BY name ASC;
-- 14. **Write a query to display the names of players who were the player of the match in the game played on 2020-03-09'.
-- Display the records sorted in ascending order based on player name.**
...
WHERE country = 'Iran'
ORDER BY team.name;
-- 18. **Write a query to display the event number and the defence points of `Fazel Atrachali` in each event. 
-- Display the records sorted in ascending order based on event number.**
...
ORDER BY team.name;
-- 20. **Write a query to display the names of players who were the player of the match in the games held in March 2020. 
-- Display the records sorted in ascending order based on player name.**
